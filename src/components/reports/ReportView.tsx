        ...
        <div className="max-w-5xl 2xl:max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
          ...
          >
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="font-mono text-[10px]" style={{ color: "var(--text-muted)" }}>Hub AI analysis</span>
            </div>
          ...
          >
            <p className="font-mono text-[10px]" style={{ color: "var(--text-muted)" }}>
              Generated by Enterprise Hub AI · {new Date().toLocaleDateString("en-GB", { day: "numeric", month: "short", year: "numeric" })}
            </p>
            <div className="flex items-center gap-2">
              {/* Save / bookmark */}
              {onSave && (
                <button
                  onClick={onSave}
                  className="font-mono text-[10px] tracking-widest uppercase px-4 py-2 transition-all flex items-center gap-2"
                  style={
                    isSaved
                  ...
                  onMouseEnter={(e) => {
                    if (!isSaved) (e.currentTarget as HTMLElement).style.color = "var(--ink)";
                  }}
                  onMouseLeave={(e) => {
                    if (!isSaved) (e.currentTarget as HTMLElement).style.color = "var(--text-muted)";
                  }}
                >
                  {isSaved ? (
                    <>
                      <svg width="11" height="12" viewBox="0 0 12 14" fill="currentColor" stroke="none">
                        <path d="M2 1h8a1 1 0 011 1v10.5l-5-3-5 3V2a1 1 0 011-1z" />
                      </svg>
                      Saved
                    </>
                  ) : (
                    <>
                      <svg width="11" height="12" viewBox="0 0 12 14" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M2 1h8a1 1 0 011 1v10.5l-5-3-5 3V2a1 1 0 011-1z" />
                      </svg>
                      Save
                    </>
