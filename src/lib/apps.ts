...
export const apps: App[] = [
  ...
  { id: "salesforce", name: "Salesforce",    category: "CRM",       color: "#00A1E0", logo: "salesforce",         url: "https://orgfarm-5cbe5ca2ca-dev-ed.develop.my.salesforce.com" },
