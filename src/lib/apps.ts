...
export const apps: App[] = [
  ...
  { id: "servicenow", name: "ServiceNow",        category: "ITSM",          color: "#62D84E", logo: "servicenow",       url: "https://your-instance.service-now.com" },
  { id: "adobe-sign", name: "Adobe Sign",        category: "Documents",     color: "#FF0000", logo: "adobe",            url: "https://secure.adobesign.com" },
...
export function logoUrl(slug: string, color: string): string {
